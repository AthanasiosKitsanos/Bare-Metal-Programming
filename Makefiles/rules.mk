...
$(BOOT_STAGE_2_BIN): $(BOOT_STAGE_2_OBJ)
	$(LD) -Ttext 0x7E00 --oformat binary $(BOOT_STAGE_2_OBJ) -o $(BOOT_STAGE_2_BIN)

$(BOOT_STAGE_2_PADDED_BIN): $(BOOT_STAGE_2_BIN)
	size=$$(wc -c < $(BOOT_STAGE_2_BIN)); \
	if [ $$size -gt 2048 ]; then \
		echo "Stage 2 is too large."; \
		exit 1; \
	fi;	\
	cp $(BOOT_STAGE_2_BIN) $(BOOT_STAGE_2_PADDED_BIN); \
	truncate -s 2048 $(BOOT_STAGE_2_PADDED_BIN)

$(OS_IMAGE): $(BOOT_STAGE_1_BIN) $(BOOT_STAGE_2_PADDED_BIN)

	cat $(BOOT_STAGE_1_BIN) $(BOOT_STAGE_2_PADDED_BIN) > $(OS_IMAGE)
