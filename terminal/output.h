...
#include "io/vga_text_buffer.h"
#include "io/hardware_cursor.h"
#include <stddef.h>
#include <stdint.h>
...
namespace terminal
{
    ...
    {
        // Private Members
        inline static io::vga_text_buffer buffer;
        ...
        [[gnu::always_inline]]
        inline static void sync_cursor() noexcept { io::hardware_cursor::set_position(buffer.get_position()); }
