...
# Code 32
$(CODE_32_ELF): $(BOOT_STAGE_2_OBJ) $(INTERRUPT_ENTRY_OBJ) $(PM_ENTRY_OBJ) $(MAIN_OBJ) $(KERNEL_A) $(DRIVERS_A) $(UTILITIES_A) $(KERNEL_MEMORY_A) $(APPS_A)
	$(LD) -T $(CODE_32_LINKER) -o $(CODE_32_ELF) \
		$(BOOT_STAGE_2_OBJ) $(INTERRUPT_ENTRY_OBJ) $(PM_ENTRY_OBJ) $(MAIN_OBJ) \
		$(LINK_DRIVERS_LIB) $(LINK_KERNEL_LIB) $(LINK_UTILITIES_LIB) $(LINK_KERNEL_MEMORY_LIB) $(LINK_APPS_LIB)
